...
class TestAffineRegistration:
    ...
    def test_pyramid_creation_2d(self, device, create_test_image_2d):
        ...
        mse = MSE()
        reg = AffineRegistration(similarity_metric=mse, shrink_factors=[4, 2, 1], smoothing_sigmas=[2.0, 1.0, 0.0])
        ...
        pyramid = reg._create_pyramid(image, shrink_factors=[4, 2, 1], smoothing_sigmas=[2.0, 1.0, 0.0])
    ...
    def test_pyramid_creation_3d(self, device, create_test_image_3d):
        ...
        mse = MSE()
        reg = AffineRegistration(similarity_metric=mse, shrink_factors=[4, 2], smoothing_sigmas=[2.0, 1.0])
        ...
        pyramid = reg._create_pyramid(image, shrink_factors=[4, 2], smoothing_sigmas=[2.0, 1.0])
    ...
    def test_register_with_initial_transform(
        ...
        mse = MSE()
        reg = AffineRegistration(
            similarity_metric=mse, shrink_factors=[1], smoothing_sigmas=[0.0], num_iterations=[5]
        )
    ...
    def test_multi_scale_registration(self, device, create_test_image_2d):
        ...
        mse = MSE()
        reg = AffineRegistration(
            similarity_metric=mse, shrink_factors=[4, 2, 1], smoothing_sigmas=[2.0, 1.0, 0.0], num_iterations=[5, 5, 5]
        )
...
class TestAffineRegistrationIntegration:
    ...
    def test_registration_different_metrics(self, device, create_test_image_2d):
        ...
        for metric in metrics:
            reg = AffineRegistration(
                similarity_metric=metric, shrink_factors=[1], smoothing_sigmas=[0.0], num_iterations=[10]
            )
